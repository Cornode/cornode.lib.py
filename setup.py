...
setup(
  name        = 'PyOTA',
  description = 'cornode API library for Python',
  url         = 'https://github.com/cornodeledger/cornode.lib.py',
  version     = '1.1.3',
  ...
  keywords =
    'cornode,tangle,iot,internet of things,api,library,cryptocurrency,'
    'balanced ternary',
