...
from cornode import Address, Bundle, cornode, TransactionHash
from cornode.adapter import MockAdapter
from cornode.commands.extended.get_account_data import GetAccountDataCommand, \
...
class GetAccountDataCommandTestCase(TestCase):
  ...
  def test_wireup(self):
    ...
    self.assertIsInstance(
      cornode(self.adapter).getAccountData,
