...
from cornode import Address, Bundle, cornode, ProposedTransaction, \
  TransactionTrytes, TryteString
from cornode.adapter import MockAdapter
from cornode.commands.extended.send_transfer import SendTransferCommand
...
class SendTransferCommandTestCase(TestCase):
  ...
  def test_wireup(self):
    ...
    self.assertIsInstance(
      cornode(self.adapter).sendTransfer,
      SendTransferCommand,
    )
  ...
  def test_happy_path(self):
    ...
    with patch(
        'cornode.commands.extended.prepare_transfer.PrepareTransferCommand._execute',
        mock_prepare_transfer,
    ):
      with patch(
          'cornode.commands.extended.send_trytes.SendTrytesCommand._execute',
          mock_send_trytes,
      ):
