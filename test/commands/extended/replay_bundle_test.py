...
from cornode import Address, Bundle, BundleHash, Fragment, Hash, cornode, Tag, \
  Transaction, TransactionHash
from cornode.adapter import MockAdapter
from cornode.commands.extended.replay_bundle import ReplayBundleCommand
...
class ReplayBundleCommandTestCase(TestCase):
  ...
  def test_wireup(self):
    ...
    self.assertIsInstance(
      cornode(self.adapter).replayBundle,
      ReplayBundleCommand,
    )
