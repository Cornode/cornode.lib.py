...
from cornode import Address, TRITS_PER_TRYTE, TrytesCompatible
from cornode.crypto import Curl
from cornode.crypto.signing import KeyGenerator, KeyIterator
from cornode.crypto.types import Digest, PrivateKey, Seed
...
class AddressGenerator(Iterable[Address]):
  ...
  :py:meth:`cornode.api.cornodeApi.get_new_addresses` instead.

  Note also that :py:meth:`cornode.api.cornodeApi.get_new_addresses` uses
  ...
  References:
    ...
    - :py:class:`cornode.transaction.BundleValidator`
  """
