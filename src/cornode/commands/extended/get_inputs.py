...
import filters as f
from cornode import BadApiResponse
...
from cornode.commands.extended.utils import iter_used_addresses
...
class GetInputsCommand(FilterCommand):
  ...
  See :py:meth:`cornode.api.cornode.get_inputs` for more info.
  """
  command = 'getInputs'
