...
import filters as f
from cornode import Address, BadApiResponse, ProposedBundle, \
  ProposedTransaction
from cornode.commands import FilterCommand, RequestFilter
from cornode.commands.core.get_balances import GetBalancesCommand
from cornode.commands.extended.get_inputs import GetInputsCommand
from cornode.commands.extended.get_new_addresses import GetNewAddressesCommand
from cornode.crypto.signing import KeyGenerator
from cornode.crypto.types import Seed
from cornode.exceptions import with_context
...
class PrepareTransferCommand(FilterCommand):
  ...
  See :py:meth:`cornode.api.cornode.prepare_transfer` for more info.
  """
