...
import filters as f
from cornode import BadApiResponse, Bundle, BundleHash, Transaction, \
  TransactionHash, TryteString
from cornode.commands import FilterCommand, RequestFilter
from cornode.commands.core.get_trytes import GetTrytesCommand
...
class GetBundlesCommand(FilterCommand):
  ...
  See :py:meth:`cornode.api.cornode.get_bundles` for more info.
  """
  command = 'getBundles'
