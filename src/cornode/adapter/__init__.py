...
from cornode.json import JsonEncoder
...
if PY2:
  ...
  # https://travis-ci.org/cornodeledger/cornode.lib.py/jobs/191974244
...
class BaseAdapter(with_metaclass(AdapterMeta)):
  """
  Interface for cornode API adapters.

  Adapters make it easy to customize the way an Strictcornode instance
