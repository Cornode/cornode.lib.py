...
from cornode import AdapterSpec, Address, ProposedTransaction, Tag, \
  TransactionHash, TransactionTrytes, TryteString, TrytesCompatible
from cornode.adapter import BaseAdapter, resolve_adapter
from cornode.commands import BaseCommand, CustomCommand, core, \
...
class ApiMeta(type):
  """
  Manages command registries for cornode API base classes.
  """
...
class Strictcornode(with_metaclass(ApiMeta)):
  """
  API to send HTTP requests for communicating with an cornode node.

  This implementation only exposes the "core" API methods.  For a more
  feature-complete implementation, use :py:class:`cornode` instead.

  References:
    - https://cornode.readme.io/docs/getting-started
  """
  commands = discover_commands('cornode.commands.core')
  ...
  def __init__(self, adapter, testnet=False):
    ...
    """
    super(Strictcornode, self).__init__()
  ...
  def __getattr__(self, command):
    ...
    References:
      - https://cornode.readme.io/docs/making-requests
    """
    try:
  ...
  def add_neighbors(self, uris):
    ...
    References:
      - https://cornode.readme.io/docs/addneighors
    """
  ...
  def attach_to_tangle(
    ...
    References:
      - https://cornode.readme.io/docs/attachtotangle
    """
  ...
  def broadcast_transactions(self, trytes):
    ...
    References:
      - https://cornode.readme.io/docs/broadcasttransactions
    """
  ...
  def find_transactions(
    ...
    References:
      - https://cornode.readme.io/docs/findtransactions
    """
  ...
  def get_balances(self, addresses, threshold=100):
    ...
    References:
      - https://cornode.readme.io/docs/getbalances
    """
  ...
  def get_inclusion_states(self, transactions, tips):
    ...
    References:
      - https://cornode.readme.io/docs/getinclusionstates
    """
  ...
  def get_neighbors(self):
    ...
    References:
      - https://cornode.readme.io/docs/getneighborsactivity
    """
  ...
  def get_node_info(self):
    ...
    References:
      - https://cornode.readme.io/docs/getnodeinfo
    """
  ...
  def get_tips(self):
    ...
    References:
      - https://cornode.readme.io/docs/gettips
      - https://cornode.readme.io/docs/glossary#cornode-terms
    """
  ...
  def get_transactions_to_approve(self, depth):
    ...
    References:
      - https://cornode.readme.io/docs/gettransactionstoapprove
    """
  ...
  def get_trytes(self, hashes):
    ...
    References:
      - https://cornode.readme.io/docs/gettrytes
    """
  ...
  def interrupt_attaching_to_tangle(self):
    ...
    References:
      - https://cornode.readme.io/docs/interruptattachingtotangle
    """
  ...
  def remove_neighbors(self, uris):
    ...
    References:
      - https://cornode.readme.io/docs/removeneighors
    """
  ...
  def store_transactions(self, trytes):
    ...
    References:
      - https://cornode.readme.io/docs/storetransactions
    """
    return core.StoreTransactionsCommand(self.adapter)(trytes=trytes)


class cornode(Strictcornode):
  """
  ...
  References:
    - https://cornode.readme.io/docs/getting-started
    - https://github.com/cornodeledger/wiki/blob/master/api-proposal.md
  """
  commands = discover_commands('cornode.commands.extended')
  ...
  def broadcast_and_store(self, trytes):
    ...
    References:
      - https://github.com/cornodeledger/wiki/blob/master/api-proposal.md#broadcastandstore
    """
  ...
  def get_bundles(self, transaction):
    ...
    :raise:
      - :py:class:`cornode.adapter.BadApiResponse` if any of the
        bundles fails validation.

    References:
      - https://github.com/cornodeledger/wiki/blob/master/api-proposal.md#getbundle
    """
  ...
  def get_inputs(self, start=0, stop=None, threshold=None):
    ...
    :return:
      ...
      Example::
         ...
         response = cornode.get_inputs(...)

         input0 = response['inputs'][0] # type: Address
         input0.balance # 42

    :raise:
      - :py:class:`cornode.adapter.BadApiResponse` if ``threshold`` is not
        met.  Not applicable if ``threshold`` is ``None``.

    References:
      - https://github.com/cornodeledger/wiki/blob/master/api-proposal.md#getinputs
    """
  ...
  def get_new_addresses(self, index=0, count=1):
    ...
    References:
      - https://github.com/cornodeledger/wiki/blob/master/api-proposal.md#getnewaddress
    """
  ...
  def get_transfers(self, start=0, stop=None, inclusion_states=False):
    ...
    References:
      - https://github.com/cornodeledger/wiki/blob/master/api-proposal.md#gettransfers
    """
  ...
  def prepare_transfer(self, transfers, inputs=None, change_address=None):
    ...
    References:
      - https://github.com/cornodeledger/wiki/blob/master/api-proposal.md#preparetransfers
    """
  ...
  def replay_bundle(
    ...
    References:
      - https://github.com/cornodeledger/wiki/blob/master/api-proposal.md#replaytransfer
    """
    if min_weight_magnitude is None:
      min_weight_magnitude = self.default_min_weight_magnitude
  ...
  def send_transfer(
    ...
    References:
      - https://github.com/cornodeledger/wiki/blob/master/api-proposal.md#sendtransfer
    """
    if min_weight_magnitude is None:
      min_weight_magnitude = self.default_min_weight_magnitude
  ...
  def send_trytes(self, trytes, depth, min_weight_magnitude=None):
    ...
    References:
      - https://github.com/cornodeledger/wiki/blob/master/api-proposal.md#sendtrytes
    """
    if min_weight_magnitude is None:
      min_weight_magnitude = self.default_min_weight_magnitude
