...
from cornode import *
from cornode.adapter.sandbox import SandboxAdapter
...
cornode =\
  cornode(
    ...
    adapter = SandboxAdapter(
      ...
      uri = 'https://sandbox.cornodetoken.com/api/v1/',
...
# For more information, see :py:meth:`cornode.send_transfer`.
# noinspection SpellCheckingInspection
cornode.send_transfer(
  depth = 100,
