# coding=utf-8
"""
Generates a shiny new cornode address that you can use for transfers!
"""
...
from cornode import __version__, cornode
...
def output_seed(seed):
  ...
  """
  print(
    'WARNING: Anyone who has your seed can spend your cornodes! '
